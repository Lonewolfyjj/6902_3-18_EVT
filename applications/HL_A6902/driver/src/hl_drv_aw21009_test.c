...
int hl_drv_aw21009_test_open(int argc, char* argv[])
{
    ...
    hl_drv_aw21009_ctrl(HL_DRV_AW21009_LED_DEV_1, HL_DRV_AW21009_SET_GROUP_CTRL_DISABLE, &flag, sizeof(flag));

    led_group = HL_DRV_AW21009_LED_GROUP_1 | HL_DRV_AW21009_LED_GROUP_2 | HL_DRV_AW21009_LED_GROUP_3;

    hl_drv_aw21009_ctrl(HL_DRV_AW21009_LED_DEV_1, HL_DRV_AW21009_SET_LED_GROUP_MODE, &led_group, sizeof(led_group));
    ...
    hl_drv_aw21009_ctrl(HL_DRV_AW21009_LED_DEV_1, HL_DRV_AW21009_SET_AUTO_BREATH_PARAM, &auto_breath,
                        sizeof(auto_breath));
    ...
    hl_drv_aw21009_ctrl(HL_DRV_AW21009_LED_DEV_1, HL_DRV_AW21009_SET_LED_LIGHT_EFFECT, &light, sizeof(light));

    pat_mode = HL_DRV_AW21009_PAT_AUTO_BREATH_MODE;

    hl_drv_aw21009_ctrl(HL_DRV_AW21009_LED_DEV_1, HL_DRV_AW21009_SET_PATTERN_MODE, &pat_mode, sizeof(pat_mode));
