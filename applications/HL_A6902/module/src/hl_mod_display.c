...
//         LOG_D("display: record led new mode\r\n");
...
//         }
//         break;
//         case MSG_SCR_PAGE_CHANGE_CMD: {
//             hl_screen_page_e val = *(uint32_t*)ptr;
//             if (val >= RGB888_COLOR_CNT) {
//                 LOG_D("[%s][line:%d] cmd(%d) err!!! \r\n", __FUNCTION__, __LINE__, cmd);
//                 res = HL_DISPLAY_FAILED;
//             } else {
//                 hl_mod_display_scr_set_page(val);
//                 LOG_D("[%s][line:%d] val(%d)!!! \r\n", __FUNCTION__, __LINE__, val);
//             }
//         }
//         break;
