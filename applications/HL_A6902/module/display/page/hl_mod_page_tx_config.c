...
//     lv_obj_t* btn1 = lv_btn_create(app_window);
...
//     lv_obj_t* btn2 = lv_btn_create(app_window);
...
//     result =
//         PageManager_PageRegister(PAGE_FIRST_MENU, hl_mod_page_setup, hl_mod_page_loop, hl_mod_page_exit, hl_mod_page_event);
