...
#define RT_USING_COMMON_PART_TABLE
/* RT_USING_BOARD_RK2108_EVB is not set */
/* RT_USING_BOARD_AUDIO_DEMO_RK2108_V10 is not set */
...
/* RT_USING_I2STDM0 is not set */
/* RT_USING_I2STDM1 is not set */
#define RT_USING_PDM
/* RT_USING_PDM0 is not set */
#define RT_USING_VAD
