...
struct nau88l25b_priv* nau88l25bhp_test = NULL;

#define HL_CODEC_SET 0
//#define RT_CODEC_NAU88L21 1
NAU88L25B_REG_T s_nau88l25bhp_param[] = {
#if HL_IS_TX_DEVICE()
...
#else
    //{ 0x0000, 0x0000 }, // nau88l25B配置--hl-mclk-20230203(RX)
    { 0x0001, 0x067C }, { 0x0002, 0x0000 }, { 0x0003, 0x0050 }, { 0x0004, 0x0081 },
    { 0x0005, 0x0000 }, { 0x0006, 0x0408 }, { 0x0007, 0x0010 }, { 0x0008, 0x1000 }, { 0x0009, 0x6000 },
    { 0x000A, 0xF13C }, { 0x000C, 0x004C }, { 0x000D, 0x0000 }, { 0x000F, 0x0000 }, { 0x0010, 0x0000 },
    ...
    { 0x001B, 0x0000 }, { 0x001C, 0x000A }, { 0x001D, 0x1015 }, { 0x001E, 0x0000 }, { 0x001F, 0x0000 },
    ...
    { 0x0030, 0x0000 }, { 0x0031, 0x1004 }, { 0x0032, 0x0000 }, // //0x0082 }, 老链路 //0x0208 }, 新链路
    { 0x0033, 0x00DB }, //0x00BF }, 老链路 //0x00CF }, 新链路
    { 0x0034, 0x02DB }, //0x00BF }, 老链路 //0x00CF }, 新链路
    ...
    { 0x0073, 0x332C }, { 0x0074, 0x4007 }, { 0x0076, 0x3140 }, { 0x0077, 0x0002 }, { 0x007F, 0x013F },
    { 0x0080, 0x0420 }, { 0x0081, 0x002C }, { 0x0082, 0x0060 },
#endif
};

rt_inline struct nau88l25b_priv* to_nau88l25bhp_priv(struct audio_codec* codec)
{
...
int rt_hw_codec_nau88l25bhp_init(void)
{
    struct codec_desc*     codec_dev = (struct codec_desc*)&codec_nau88l25b_hp;
...
INIT_DEVICE_EXPORT(rt_hw_codec_nau88l25bhp_init);

int hl_nau88l25hp_test(int argc, char** argv)
{
    ...
    if (!strcmp("read", argv[1])) {
        ...
        es_rd_reg(nau88l25bhp_test->i2c_client, nau88l25_param[0], &nau88l25_param[1]);
        ...
        es_wr_reg(nau88l25bhp_test->i2c_client, nau88l25_param[0], nau88l25_param[1]);
...
MSH_CMD_EXPORT(hl_nau88l25hp_test, nau88l25 hp reg ctrl cmd);
