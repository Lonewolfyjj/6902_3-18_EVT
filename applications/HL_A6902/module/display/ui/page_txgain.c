...
{  
    ...
    bar1 = lv_bar_creat_fun(btn_left,btn_left_cb,-14,0,135,48,ptr->left_volume_min,ptr->left_volume_max,ptr->left_volume);
    bar2 = lv_bar_creat_fun(btn_right,btn_right_cb,-14,0,135,48,ptr->right_volume_min,ptr->right_volume_max,ptr->right_volume);
