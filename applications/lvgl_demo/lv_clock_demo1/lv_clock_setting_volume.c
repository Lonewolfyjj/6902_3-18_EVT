...
/*********************
 *  LV_CLOCK_SETTING_VOLUME
 *********************/

struct lv_clock_setting_volume_t
{
...
static struct lv_clock_setting_volume_t mdata;
...
lv_obj_t *lv_setting_volume_init(void)
{
    ...
    lv_slider_set_value(mdata.slider, 50, LV_ANIM_OFF);
...
void lv_setting_volume_deinit(void)
{
