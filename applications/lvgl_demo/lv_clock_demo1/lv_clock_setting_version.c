...
/*********************
 *  LV_CLOCK_SETTING_VERSION
 *********************/

struct lv_clock_setting_version_t
{
...
static struct lv_clock_setting_version_t mdata;

static void event_handler(lv_obj_t *obj, lv_event_t event)
{
    if (event == LV_EVENT_CLICKED)
    {
        lv_setting_version_deinit();
    }
}
...
lv_obj_t *lv_setting_version_init(void)
{
    ...
    lv_label_set_text(mdata.obj_label, FIRMWARE_AUTO_VERSION);
...
void lv_setting_version_deinit(void)
{
