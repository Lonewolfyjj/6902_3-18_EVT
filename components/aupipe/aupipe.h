...
typedef struct aupipe_audio_buffer ApAudioBuffer;
...
typedef int (*object_init)(ApObject *obj);
...
typedef ApPad *(*object_get_pad)(ApObject *obj, int type);
